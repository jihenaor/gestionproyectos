  ...
  template: `
    <div class="estructura-form">
      <header class="estructura-form__header">
        <h2 class="estructura-form__title">P-031A: Comodato</h2>
        <p class="estructura-form__description">
          Diligencie la información del contrato de comodato (cesión gratuita) del inmueble
      ...
      <form class="estructura-form__form">
        ...
        <app-form-field [label]="'Uso Autorizado'" [fieldId]="'usoAutorizado'" [isRequired]="true"
          [description]="'Describe el uso específico autorizado para el inmueble en comodato'">
          <textarea id="usoAutorizado" class="form-textarea" [(ngModel)]="datos.usoAutorizado"
            rows="3" maxlength="500"></textarea>
        </app-form-field>

        <div class="form-row">
          <app-form-field [label]="'Fecha Inicio Comodato'" [fieldId]="'fechaInicioComodato'">
            <input type="date" id="fechaInicioComodato" class="form-input"
              [(ngModel)]="datos.fechaInicioComodato" />
          </app-form-field>

          <app-form-field [label]="'Fecha Fin Comodato'" [fieldId]="'fechaFinComodato'">
            <input type="date" id="fechaFinComodato" class="form-input"
              [(ngModel)]="datos.fechaFinComodato" />
          </app-form-field>
        </div>

        <app-form-field [label]="'Nombre del Cedente'" [fieldId]="'nombreCedente'">
          <input type="text" id="nombreCedente" class="form-input" [(ngModel)]="datos.nombreCedente"
            maxlength="200" placeholder="Nombre de quien cede el inmueble" />
        </app-form-field>
      </form>
...
export class P031AFormComponent {
  ...
  guardar(): void {
    ...
    this.estructuraService.guardarP031A(this.datos).subscribe({
      next: (result) => {
        this.guardando.set(false);
        this.guardado.emit({ estructura: 'P-031A', datos: result });
      },
      error: () => {
        this.guardando.set(false);
